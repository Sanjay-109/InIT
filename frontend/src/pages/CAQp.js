...
function CAQp() {
    ...
    useEffect(() => {
        const fetchQpNames = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/fetch-qps/CAQP`);
    ...
    const handleUpload = async () => {
        ...
        try {
            await axios.post(`${API_BASE_URL}/upload-qpdf/CAQP`, formData, {
                headers: {
        ...
        <div>
            <header className="header">
                ...
                <div className='dash'>
                    ...
                    <Link to="/cacourse" className="nav-link">Courses</Link>
                    <Link to="/caqp" className="nav-linkc">Question papers</Link>
                    </nav>
                </div>
            </header>
