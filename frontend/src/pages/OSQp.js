...
function OSQp() {
    ...
    useEffect(() => {
        const fetchQpNames = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/fetch-qps/OSQP`);
    ...
    const handleUpload = async () => {
        ...
        try {
            await axios.post(`${API_BASE_URL}/upload-qpdf/OSQP`, formData, {
                headers: {
            ...
            <header className="header">
                ...
                <div className='dash'>
                    ...
                    <nav className="nav">
                        ...
                        <Link to="/oscourse" className="nav-link">Courses</Link>
                        <Link to="/osqp" className="nav-linkc">Question papers</Link>
                    </nav>
                </div>
            </header>
