...
function CAPage() {
    ...
    useEffect(() => {
        const fetchBookNames = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/fetch-books/CA`);
    ...
    const handleUpload = async () => {
        ...
        try {
            await axios.post(`${API_BASE_URL}/upload-pdf/CA`, formData, {
                headers: {
        ...
        <div>
            <header className="header">
                ...
                <div className='dash'>
                    ...
                    <Link to="/ca" className="nav-linkc">Books</Link>
