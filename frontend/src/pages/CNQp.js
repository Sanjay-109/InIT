...
function CNQp() {
    ...
    useEffect(() => {
        const fetchQpNames = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/fetch-qps/CNQP`);
    ...
    const handleUpload = async () => {
        ...
        try {
            await axios.post(`${API_BASE_URL}/upload-qpdf/CNQP`, formData, {
                headers: {
        ...
        <div>
            <header className="header">
                ...
                <div className='dash'>
                    ...
                    <Link to="/cnqp" className="nav-linkc">Question papers</Link>
                    </nav>
                </div>
            </header>
