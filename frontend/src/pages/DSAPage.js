...
function DSAPage() {
    ...
    useEffect(() => {
        const fetchBookNames = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/fetch-books/DSA`);
    ...
    const handleUpload = async () => {
        ...
        try {
            await axios.post(`${API_BASE_URL}/upload-pdf/DSA`, formData, {
                headers: {
        ...
        <div>
            <header className="header">
                ...
                <div className='dash'>
                    ...
                    <Link to="/dsa" className="nav-linkc">Books</Link>
