...
function OSPage() {
    ...
    useEffect(() => {
        const fetchBookNames = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/fetch-books/OS`);
    ...
    const handleUpload = async () => {
        ...
        try {
            await axios.post(`${API_BASE_URL}/upload-pdf/OS`, formData, {
                headers: {
        ...
        <div>
            <header className="header">
                ...
                <div className='dash'>
                    ...
                    <Link to="/os" className="nav-linkc">Books</Link>
